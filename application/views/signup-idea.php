...
<html>
   <head>
      <title>Pendaftaran - Pengembangan Ide Bisnis TIK - ITCC 2016</title>
      <!--fav icon-->
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <?php echo $errormsg; ?>
                  <div class="box">
                     <form action="<?php echo base_url();?>Auth/signup/idea" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                     <div class="box-head">
                        <h3>Form Pendaftaran Pengembangan Ide Bisnis TIK</h3>
                     </div>
                     <div class="box-body">
                        <div class="box-body-col">
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-9">
                                 <input class="form-control" placeholder="ex. 'Team Greentea'" name="groupname" required="required" type="text" value="<?php echo $groupname;?>">
                             </div>
                           </div>
                           <div class="form-group">
                             <label class="control-label col-md-3">Asal Institusi</label>
                             <div class="col-md-9">
                                 <input class="form-control" placeholder="ex. 'SMA/SMK, Universitas'" name="institution" required="required" type="text" value="<?php echo $institution;?>">
                             </div>
                           </div>
                        </div>
                        <div class="box-body-col">
