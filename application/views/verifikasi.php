...
<html>
   <head>
      <title>Verifikasi - ITCC 2016</title>
      <!--fav icon-->
                           ...
                           <div class="col-md-6">
                              <div class="box-body-col" style="min-height:250px;">
                                 ...
                                 <div class="alert alert-success">
                                    ...
                                    <p style="text-align: justify;text-justify: inter-word;">Apakah data anda sudah terisi lengkap ? Silahkan dilanjutkan dengan pembayaran uang lomba melalui ATM pada rekening <b>Bank BRI</b>, <b><i>1095 0100 4980 503 a.n Veranita Lamrotua</i></b>. Nominal uang yang ditransfer adalah <b>Rp. <?php if($this->session->userdata('category')=='WEB'||$this->session->userdata('category')=='PROG'){
                                       $nominal=80000+$this->session->userdata('group_id');echo $nominal;} else{  $nominal=125000+$this->session->userdata('group_id');echo $nominal;}?>,-</b>. Lalu kirimkan bukti pembayaran via ATM ke halaman verifikasi. Panitia akan segera memverifikasi data anda. </p>
                                       <br>
