...
<html>
   <head>
      <title>Pendaftaran - Pemrograman - ITCC 2016</title>
      <!--fav icon-->
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-6 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <?php echo $errormsg; ?>
                  <div class="box">
                     <form action="<?php echo base_url();?>Auth/signup/prog" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                     <div class="box-head">
                        <h3>Form Pendaftaran Pemrograman</h3>
                     </div>
                     <div class="box-body">
